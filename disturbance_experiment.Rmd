...
Graphing
```{r}
g <- ggplot(data = chlfin2, aes((estimate), animal)) + geom_point(size=4) + geom_errorbarh(aes(xmin=(lower.CL), xmax = (upper.CL)), height = 0.3) + ylab("") + xlab(str_wrap("Log10 Fold Change in Final Chlorophyll", width = 25 )) + theme(axis.line = element_line(colour = "black"), panel.border = element_blank()) + scale_y_discrete(labels = str_wrap(c("No Herbivore",'Physa Only','Daphnia Only', 'Daphnia and Physa'), width= 10)) + geom_vline(xintercept = 0, linetype= "dashed", color = "gray68")

g1 <- ggplot(data = mchl2, aes(exp(estimate), animal)) + geom_point(size=4) + geom_errorbarh(aes(xmin=exp(lower.CL), xmax = exp(upper.CL)), height = 0.3) + ylab("") + xlab(str_wrap("Log10 Fold Change in Maximum Chlorophyll ", width = 27)) + theme(axis.line = element_line(colour = "black"), panel.border = element_blank() ) + scale_y_discrete(labels = str_wrap(c("No Herbivore",'Physa Only','Daphnia Only', 'Daphnia and Physa'), width= 10))+ geom_vline(xintercept = 0, linetype= "dashed", color = "gray68")

g2 <- ggplot(data = ammfin2, aes(exp(estimate), animal)) + geom_point(size=4) + geom_errorbarh(aes(xmin=exp(lower.CL), xmax = exp(upper.CL)), height = 0.3) + ylab("") + xlab(str_wrap("Log10 Fold Change in Final Ammonium",width = 25)) + 
  theme(axis.line = element_line(colour = "black"), panel.border = element_blank()) + scale_y_discrete(labels = str_wrap(c("No Herbivore",'Physa Only','Daphnia Only', 'Daphnia and Physa'), width= 10))+ geom_vline(xintercept = 0, linetype= "dashed", color = "gray68")

g3 <- ggplot(data = mfin2, aes(exp(estimate), animal)) + geom_point(size=4) + geom_errorbarh(aes(xmin=exp(lower.CL), xmax = exp(upper.CL)), height = 0.3) + ylab(" ") + xlab(str_wrap("Log10 Fold Change in Maximum Ammonium", width = 25)) + 
  theme(axis.line = element_line(colour = "black"), panel.border = element_blank())+ scale_y_discrete(labels = str_wrap(c("No Herbivore",'Physa Only','Daphnia Only', 'Daphnia and Physa'), width= 10)) + geom_vline(xintercept = 0, linetype= "dashed", color = "gray68")
...
geom_point(size = 3) + geom_errorbar(aes(ymin= lower, ymax = upper), width = 0.3) + xlab(" ") + ylab("Maximum Chlorophyll (ug/L)") + theme(legend.position = "none") + theme(axis.line = element_line(colour = "black"), panel.border = element_blank()) + scale_x_discrete(labels = function(x) str_wrap(c("Daphnia and Physa Not Disturbed", "Daphnia and Physa Disturbed", "Daphia Not Disturbed", "Daphnia Disturbed","No Herbivore Not Disturbed", "No Herbivore Disturbed", "Physa Not Disturbed", "Physa Disturbed" ), width = 8))
...
geom_point( size = 3) + geom_errorbar(aes(ymin= lower, ymax = upper), width = 0.3) + xlab(" ") + ylab("Final Ammonium (mg/L)") + theme(legend.position = "none") + theme(axis.line = element_line(colour = "black"), panel.border = element_blank()) + scale_x_discrete(labels = function(x) str_wrap(c("Daphnia and Physa Not Disturbed", "Daphnia and Physa Disturbed", "Daphia Not Disturbed", "Daphnia Disturbed","No Herbivore Not Disturbed", "No Herbivore Disturbed", "Physa Not Disturbed", "Physa Disturbed"), width = 8))
...
geom_point(size = 3) + geom_errorbar(aes(ymin= lower, ymax = upper), width = 0.3) + xlab(" ") + ylab("Maximum Ammonium (mg/L)") + theme(legend.position = "none") + theme(axis.line = element_line(colour = "black"), panel.border = element_blank())  + scale_x_discrete(labels = function(x) str_wrap(c("Daphnia and Physa Not Disturbed", "Daphnia and Physa Disturbed", "Daphia Not Disturbed", "Daphnia Disturbed","No Herbivore Not Disturbed", "No Herbivore Disturbed", "Physa Not Disturbed", "Physa Disturbed" ), width = 8))
