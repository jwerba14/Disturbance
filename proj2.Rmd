...
## double checking i didn't add nh4 proportionally or if it was proportional all treatments were close together before disturbance
...
nh4_max_mod <- lm(max_nh4 ~ -1+animal, data = nh4_max2)
...
daph_fin_mod <- glmer(total ~ -1 + treat + (1|TankNum),data = pop_fin, family = "poisson" )
